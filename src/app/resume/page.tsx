...
const experience = [
  {
    ...
    bullets: [
      ...
      "Built a contribution-margin and unit-economics framework that helped Sales rebalance low-margin accounts and Finance optimise rebate structures, contributing to GBP 2.2M revenue growth and 15% commercial uplift.",
